...
- **Data Analysis:** Exploratory data analysis, data cleaning, visualisation, hypothesis testing, dashboard design  
- **Automation:** Workflow automation using Python and Excel to save time and reduce manual errors  
- **Documentation:** Clear technical documentation and templates for reproducibility  
- **Soft Skills:** Problem solving, critical thinking, attention to detail, autonomy, curiosity, continuous learning
...
As a biologist turned data analyst, I’m deeply curious about solving real-world problems through data. I love making complex things easier to understand and designing simple, elegant solutions.
